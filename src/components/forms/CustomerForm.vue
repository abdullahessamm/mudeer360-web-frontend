...
import { customerRules } from '@/validations/schemas'
import type { Customer } from '@/types'

const props = defineProps<{
  modelValue?: Partial<Customer> | null
  loading?: boolean
}>()

const emit = defineEmits<{
  submit: [payload: Partial<Customer>]
  cancel: []
}>()
...
<template>
  <form @submit.prevent="onSubmit" class="flex flex-column gap-3">
    <div class="field">
      <label for="c-name">الاسم <span class="text-red-500">*</span></label>
      <InputText
        id="c-name"
        v-model="form.name"
        class="w-full mt-1"
    ...
    <div class="field">
      <label for="c-phone">الهاتف</label>
      <InputText
        id="c-phone"
        v-model="form.phone"
        class="w-full mt-1"
    ...
    <div class="field">
      <label for="c-address">العنوان</label>
      <InputText
        id="c-address"
    ...
    <div class="field">
      <label for="c-notes">ملاحظات</label>
      <InputText
        id="c-notes"
        v-model="form.notes"
        class="w-full mt-1"
